...
PATH="$PATH:~/.local/bin"
LD_LIBRARY_PATH="$LD_LIBRARY_PATH:~/.local/share/julia-1.0.0/lib"
...
# OPAM configuration
. /home/wua/.opam/opam-init/init.zsh > /dev/null 2> /dev/null || true
